 ...
 *
 * <p>
 * In the case the ability to compensate the Long Running Action is time bounded, this is, the action can only be
 * undone within a certain time limit when the action has started, you can limit the lifespan of the
