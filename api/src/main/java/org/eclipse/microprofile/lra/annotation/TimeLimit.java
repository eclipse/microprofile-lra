 ...
 * <p>
 * When applied at the class level the timeout applies to any method that starts an LRA or registers a participant.</p>
 */
...
public @interface TimeLimit {
     ...
     *
     * <p>For compensations the corresponding compensation (a method annotated with {@link Compensate} in the
