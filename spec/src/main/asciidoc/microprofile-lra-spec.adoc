...
Specifically, developers should NEVER call any JAX-RS endpoint for participant methods where they
added a `Context Header` (specified by the Java constant `LRA_HTTP_CONTEXT_HEADER`)
