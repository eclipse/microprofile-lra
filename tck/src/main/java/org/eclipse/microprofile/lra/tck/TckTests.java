...
import static org.eclipse.microprofile.lra.client.LRAClient.RECOVERY_COORDINATOR_PATH_NAME;
...
//        Current.popAll();
    ...
    private void joinAndEnd(boolean waitForRecovery, boolean close, String path, String path2) throws WebApplicationException {
        ...
        if (waitForRecovery) {
            ...
            resourcePath = recoveryTarget.path(RECOVERY_COORDINATOR_PATH_NAME).path("recovery");
