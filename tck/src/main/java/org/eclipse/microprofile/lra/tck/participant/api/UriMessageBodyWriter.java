...
public class UriMessageBodyWriter implements MessageBodyWriter<URI> {
    @Override
    ...
    @Override
    public long getSize(URI uri, Class<?> aClass, Type type, Annotation[] annotations, MediaType mediaType) {
        return -1;
    }
